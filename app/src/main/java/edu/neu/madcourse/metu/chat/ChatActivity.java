            ...
            FirebaseDatabase.getInstance().getReference(Constants.MESSAGES_STORE)
                ...
                if (!isReceiverAvailable) {
                    try {
                        ...
                        data.put(Constants.MSG_SENDER_USER_ID, App.getUserId());
                        data.put(Constants.MSG_SENDER_NICKNAME, App.getNickname());
                        data.put(Constants.MSG_SENDER_AVATAR_URI, App.getAvatarUri());
