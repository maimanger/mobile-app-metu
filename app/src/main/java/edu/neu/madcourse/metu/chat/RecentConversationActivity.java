...
import edu.neu.madcourse.metu.models.RecommendedProfile;
...
public class RecentConversationActivity extends AppCompatActivity {
    ...
    private void fetchData() {
        ...
        conversation.setRecentConversation(new ChatItem("Hermione Granger", username, "come with you", System.currentTimeMillis() - 100000));
        ...
        conversation = new RecentConversation();
        conversation.setRecentContact(user);
        conversation.setRecentConversation(new ChatItem("Luna Lovegood", username, "thats a good one!!!!", System.currentTimeMillis() - 5000));
        this.conversationList.add(conversation);

        user = FakeDatabase.receiver;
        ...
        conversation = new RecentConversation();
        conversation.setRecentContact(user);
        conversation.setRecentConversation(new ChatItem(FakeDatabase.sender.getUsername(), FakeDatabase.receiver.getUsername(), "It’s a spell.", System.currentTimeMillis()));
        this.conversationList.add(conversation);
