    ...
    private void fetchData() {
        ...
        FirebaseDatabase.getInstance().getReference(Constants.CONNECTIONS_STORE).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (username.equals(user1.getUserId())) {
                    contact = user2;
                    contactUsername = user2.getUserId();
                } else if (username.equals(user2.getUserId())) {
                    contact = user1;
        ...
        FirebaseDatabase.getInstance().getReference(Constants.CONNECTIONS_STORE)
                .addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                        ...
                        if (user1 != null && username.equals(user1.getUserId())) {
                            contact = user2;
                        } else if (user2 != null && username.equals(user2.getUserId())) {
                            contact = user1;
                        } else {
                            return;
                        }
                                ...
                                .addChildEventListener(new ChildEventListener() {
                                    ...
                                    public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                        ...
                                        if (snapshot.exists()
                                            ...
                                            // todo: change it to the real avatar
//                                            Bitmap bitmap = null;
//                                            if (contact.getNickname().equals("Harry Potter")) {
//                                                bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.harry);
//                                            } else if (contact.getNickname().equals("Hermione Granger")) {
//                                                bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.hermione);
//                                            } else if (contact.getNickname().equals("Luna Lovegood")) {
//                                                bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.luna);
//                                            } else if (contact.getNickname().equals("Ron Weasley")) {
//                                                bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ron);
//                                            }
//                                            contact.setAvatarUri(bitmap!=null? BitmapUtils.encodeImage(bitmap, 160):"");
                                        ...
                                        if (snapshot.exists()) {
                                            if (snapshot.getKey().equals(Constants.CONNECTION_USER1)
                                                ...
                                                if (user.getUserId().equals(contact.getUserId())) {
                                                    ...
                                                    // todo: delete the fake avatar
//                                                    // todo: change it to the real avatar
//                                                    Bitmap bitmap = null;
//                                                    if (user.getUserId().equals("Harry Potter")) {
//                                                        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.harry);
//                                                    } else if (user.getUserId().equals("Hermione Granger")) {
//                                                        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.hermione);
//                                                    } else if (user.getUserId().equals("Luna Lovegood")) {
//                                                        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.luna);
//                                                    } else if (user.getUserId().equals("Ron Weasley")) {
//                                                        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ron);
//                                                    }
//                                                    user.setAvatarUri(BitmapUtils.encodeImage(bitmap, 160));
    ...
    private void loadUsername() {
        ...
        // todo: delete
        Toast.makeText(getApplicationContext(), this.username + " logs in", Toast.LENGTH_SHORT).show();
    }
